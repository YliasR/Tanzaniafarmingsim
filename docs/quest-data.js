...
const QUESTS = [
  ...
  // ---- TRADER & SEASONS (v1.5.0) ----
  {
    id: 'trader_deal',
    title: 'Roadside Bargain',
    desc: 'Make a trade with the wandering trader.',
    hint: 'The Mfanyabiashara walks the road between the Duka and the Soko. Press [E] near him.',
    goal: 1,
    reward: 300,
    check: () => (typeof gameStats !== 'undefined' ? gameStats.traderTrades : 0),
  },
  {
    id: 'trader_regular',
    title: 'Repeat Customer',
    desc: 'Complete 5 trades with the wandering trader.',
    hint: 'His deals change daily — check what he wants each morning.',
    goal: 5,
    reward: 700,
    check: () => (typeof gameStats !== 'undefined' ? gameStats.traderTrades : 0),
  },
  {
    id: 'masika_harvest',
    title: 'Rains of Plenty',
    desc: 'Harvest 10 crops during Masika, the long rains.',
    hint: 'Crops grow much faster in Masika — check the season in the top-left HUD.',
    goal: 10,
    reward: 800,
    check: () => questProgress.masika_harvest || 0,
  },
  {
    id: 'feather_stash',
    title: 'Feather Trader',
    desc: 'Hold 8 feathers at once.',
    hint: 'Hunt guinea fowl in the savanna — don’t sell the feathers until the quest is done.',
    goal: 8,
    reward: 450,
    check: () => inventory.feathers,
  },
  {
    id: 'full_year',
    title: 'Through the Seasons',
    desc: 'Farm through a full year — all four seasons.',
    hint: 'Kaskazi, Masika, Kiangazi, Vuli. Keep the farm alive through them all.',
    goal: 1,
    reward: 2000,
    check: () => (typeof YEAR_SECONDS !== 'undefined' && farmRealTime >= YEAR_SECONDS) ? 1 : 0,
  },
];
